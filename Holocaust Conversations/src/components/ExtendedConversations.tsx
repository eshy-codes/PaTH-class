// Extended conversation branches for Irena Sendler, Elie Wiesel, and Gerda Weissmann Klein
import { ConversationNode } from "./ConversationData";
import { elieWieselExtendedNodes } from "./ElieWieselExtended";
import { gerdaWeissmannExtendedNodes } from "./GerdaWeissmannExtended";

// IRENA SENDLER - Extended branches
export const irenaSendlerExtendedNodes: ConversationNode[] = [
  {
    ...
    userChoices: [
      { text: "How did you wake up?", nextNodeId: "how-wake-up" },
      { text: "Can people wake up too late?", nextNodeId: "wake-too-late" }
    ]
  },
  {
    id: "how-wake-up",
    ...
    userChoices: [
      { text: "Your father gave you a moral compass.", nextNodeId: "moral-compass" },
      { text: "Do you wish you could do more?", nextNodeId: "wish-more" }
    ]
  },
  {
    id: "wake-too-late",
    ...
    userChoices: [
      { text: "One life is a universe.", nextNodeId: "one-life-universe" },
      { text: "How many more children need saving?", nextNodeId: "how-many-more" }
    ]
  },
  {
    id: "families-who-help",
    ...
    userChoices: [
      { text: "Have any been caught?", nextNodeId: "families-caught" },
      { text: "What do you tell them when you place a child?", nextNodeId: "tell-families" }
    ]
  },
  {
    id: "moral-compass",
    ...
    userChoices: [
      { text: "You're giving them identity and memory.", nextNodeId: "identity-memory" },
      { text: "What if the Gestapo finds you first?", nextNodeId: "gestapo-finds" }
    ]
  },
  {
    id: "wish-more",
    ...
    userChoices: [
      { text: "You can only do what you can do.", nextNodeId: "only-what-can" },
      { text: "That guilt must be overwhelming.", nextNodeId: "guilt-overwhelming" }
    ]
  },
  {
    id: "one-life-universe",
    ...
    userChoices: [
      { text: "Focus on the worlds saved, not lost.", nextNodeId: "focus-saved" },
      { text: "How do you process that scale of loss?", nextNodeId: "scale-loss" }
    ]
  },
  {
    id: "how-many-more",
    ...
    userChoices: [
      { text: "You're preventing absolute evil.", nextNodeId: "prevent-evil" },
      { text: "What drives the people in your network?", nextNodeId: "network-drives" }
    ]
  },
  {
    id: "families-caught",
    ...
    userChoices: [
      { text: "That takes extraordinary courage.", nextNodeId: "extraordinary-courage-sendler" },
      { text: "Does that make you hesitate?", nextNodeId: "make-hesitate" }
    ]
  },
  {
    id: "tell-families",
    ...
    userChoices: [
      { text: "Memory is sacred responsibility.", nextNodeId: "memory-sacred" },
      { text: "Have you ever doubted you'd survive?", nextNodeId: "doubt-survive" }
    ]
  },
  {
    id: "identity-memory",
    ...
    timeOfDay: "Very Late - 10:30 PM",
    userChoices: [
      { text: "What if they don't want to know?", nextNodeId: "dont-want-know" },
      { text: "That must keep you going.", nextNodeId: "keep-going-sendler" }
    ]
  },
  {
    id: "gestapo-finds",
    ...
    userChoices: [
      { text: "You've put their survival above your own.", nextNodeId: "their-survival" },
      { text: "Could you withstand torture?", nextNodeId: "withstand-torture-sendler" }
    ]
  },
  {
    id: "guilt-overwhelming",
    ...
    userChoices: [
      { text: "Transforming pain into purpose.", nextNodeId: "pain-purpose" },
      { text: "How do you sleep with those memories?", nextNodeId: "sleep-memories" }
    ]
  },
  {
    id: "only-what-can",
    ...
    userChoices: [
      { text: "Collective action matters.", nextNodeId: "collective-action" },
      { text: "What's your greatest fear?", nextNodeId: "greatest-fear-sendler" }
    ]
  },
  {
    id: "focus-saved",
    ...
    userChoices: [
      { text: "How do you find light in such darkness?", nextNodeId: "find-light" },
      { text: "What will you tell Sara's mother if you see her again?", nextNodeId: "tell-saras-mother" }
    ]
  },
  {
    id: "scale-loss",
    ...
    userChoices: [
      { text: "That's survival psychology.", nextNodeId: "survival-psychology" },
      { text: "Will you grieve after the war?", nextNodeId: "grieve-after-war" }
    ]
  },
  {
    id: "prevent-evil",
    ...
    userChoices: [
      { text: "Resistance through rescue.", nextNodeId: "resistance-rescue" },
      { text: "Do you think you'll be remembered?", nextNodeId: "be-remembered-sendler" }
    ]
  },
  {
    id: "network-drives",
    ...
    userChoices: [
      { text: "Unity in diversity of motivation.", nextNodeId: "unity-diversity" },
      { text: "Have you lost people from your network?", nextNodeId: "lost-network" }
    ]
  },
  {
    id: "extraordinary-courage-sendler",
    ...
    userChoices: [
      { text: "Would you make the same choice?", nextNodeId: "same-choice" },
      { text: "How do their deaths affect you?", nextNodeId: "deaths-affect" }
    ]
  },
  {
    id: "make-hesitate",
    ...
    userChoices: [
      { text: "You carry them with you.", nextNodeId: "carry-them-sendler" },
      { text: "It's getting late. Should you rest?", nextNodeId: "rest-now-sendler" }
    ]
  },
  {
    id: "memory-sacred",
    ...
    userChoices: [
      { text: "You will survive to tell these stories.", nextNodeId: "survive-tell-sendler" },
      { text: "What story matters most?", nextNodeId: "story-matters-most" }
    ]
  },
  {
    id: "doubt-survive",
    ...
    userChoices: [
      { text: "That's profound wisdom.", nextNodeId: "profound-wisdom" },
      { text: "What gives you strength tonight?", nextNodeId: "strength-tonight" }
    ]
  },
  {
    id: "dont-want-know",
    ...
    userChoices: [
      { text: "You're giving them choice and agency.", nextNodeId: "choice-agency" }
    ]
  },
  {
    id: "keep-going-sendler",
    ...
    userChoices: [
      { text: "Hope is your weapon.", nextNodeId: "hope-weapon" }
    ]
  },
  {
    id: "their-survival",
    ...
    userChoices: [
      { text: "That's the essence of sacrifice.", nextNodeId: "essence-sacrifice" }
    ]
  },
  {
    id: "withstand-torture-sendler",
    ...
    userChoices: [
      { text: "You've planned for the worst.", nextNodeId: "planned-worst" }
    ]
  },
  {
    id: "pain-purpose",
    ...
    userChoices: [
      { text: "You've turned trauma into mission.", nextNodeId: "trauma-mission" }
    ]
  },
  {
    id: "sleep-memories",
    characterMessage: "Some nights I don't. I lie awake seeing their faces. But exhaustion eventually wins, and I sleep because I must. Tomorrow requires strength. The dead would want me to rest so I can save the living. So I try to sleep, for them.",
    userChoices: [
      { text: "Rest is resistance too.", nextNodeId: "rest-resistance" }
    ]
  },
  {
    ...
    userChoices: [
      { text: "You've built a movement.", nextNodeId: "built-movement" }
    ]
  },
  {
    id: "greatest-fear-sendler",
    ...
    userChoices: [
      { text: "Fear makes you careful, not cowardly.", nextNodeId: "fear-careful" }
    ]
  },
  {
    id: "find-light",
    characterMessage: "In the faces of the children when they're safe. In the courage of the families who open their homes. In my co-workers who risk everything daily. In moments of tenderness—a mother's last kiss, a child's shy smile in their new home. Light exists. I just have to look for it.",
    userChoices: [
      { text: "You create light by looking for it.", nextNodeId: "create-light" }
    ]
  },
  {
    id: "tell-saras-mother",
    ...
    userChoices: [
      { text: "Those words would mean everything.", nextNodeId: "words-everything" }
    ]
  },
  {
    id: "survival-psychology",
    ...
    userChoices: [
      { text: "One step, one child, one day.", nextNodeId: "one-step-child" }
    ]
  },
  {
    id: "grieve-after-war",
    ...
    userChoices: [
      { text: "But you'll have also saved thousands.", nextNodeId: "saved-thousands" }
    ]
  },
  {
    id: "resistance-rescue",
    ...
    userChoices: [
      { text: "A powerful weapon indeed.", nextNodeId: "powerful-weapon" }
    ]
  },
  {
    id: "be-remembered-sendler",
    ...
    userChoices: [
      { text: "History will remember all of you.", nextNodeId: "history-remember" }
    ]
  },
  {
    id: "unity-diversity",
    ...
    userChoices: [
      { text: "Goodness as unifier.", nextNodeId: "goodness-unifier" }
    ]
  },
  {
    id: "lost-network",
    ...
    userChoices: [
      { text: "You honor them through action.", nextNodeId: "honor-through-action" }
    ]
  },
  {
    id: "same-choice",
    ...
    userChoices: [
      { text: "That's true heroism.", nextNodeId: "true-heroism" }
    ]
  },
  {
    id: "deaths-affect",
    ...
    userChoices: [
      { text: "You carry their torch forward.", nextNodeId: "carry-torch" }
    ]
  },
  {
    id: "carry-them-sendler",
    ...
    userChoices: [
      { text: "You honor them with every rescue.", nextNodeId: "honor-every-rescue" }
    ]
  },
  {
    id: "rest-now-sendler",
    ...
    userChoices: [
      { text: "Sleep well. Tomorrow needs you strong.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "survive-tell-sendler",
    ...
    userChoices: [
      { text: "Goodness must be remembered too.", nextNodeId: "goodness-remembered" }
    ]
  },
  {
    id: "story-matters-most",
    ...
    userChoices: [
      { text: "You give voice to their sacrifice.", nextNodeId: "voice-sacrifice" }
    ]
  },
  {
    id: "profound-wisdom",
    ...
    userChoices: [
      { text: "Courage isn't absence of fear.", nextNodeId: "courage-not-absence" }
    ]
  },
  {
    id: "strength-tonight",
    ...
    userChoices: [
      { text: "You've earned your rest tonight.", nextNodeId: "earned-rest" }
    ]
  },
  {
    id: "choice-agency",
    ...
    userChoices: [
      { text: "It's everything.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "hope-weapon",
    ...
    userChoices: [
      { text: "May your hope prove true.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "essence-sacrifice",
    ...
    userChoices: [
      { text: "Love in its purest form.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "planned-worst",
    ...
    userChoices: [
      { text: "Your legacy is secure.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "trauma-mission",
    ...
    userChoices: [
      { text: "Thank you for choosing transformation.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "rest-resistance",
    characterMessage: "I never thought of it that way, but yes. Resting so I can continue fighting—that's strategic resistance. Burning out helps no one. So I'll sleep, dream of Sara safe, and wake ready to save another child. Rest to resist another day.",
    userChoices: [
      { text: "Goodnight, Irena. The world needs you.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "built-movement",
    characterMessage: "We've built a network of light in the darkness. Not a formal organization with ranks and rules, but a web of humans choosing humanity. That's more powerful than any army. Compassion organized is unstoppable.",
    userChoices: [
      { text: "May your network keep growing.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "fear-careful",
    ...
    userChoices: [
      { text: "Stay careful, stay brave.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "create-light",
    ...
    userChoices: [
      { text: "Never stop looking for light.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "words-everything",
    ...
    userChoices: [
      { text: "You give meaning to impossible choices.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "one-step-child",
    ...
    userChoices: [
      { text: "Keep taking those steps.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "saved-thousands",
    ...
    userChoices: [
      { text: "May joy outweigh grief.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "powerful-weapon",
    ...
    userChoices: [
      { text: "You're creating generations of life.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "history-remember",
    ...
    userChoices: [
      { text: "That lesson will echo forward.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "goodness-unifier",
    ...
    userChoices: [
      { text: "May that world emerge from this darkness.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "honor-through-action",
    ...
    userChoices: [
      { text: "Their sacrifice multiplies through you.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "true-heroism",
    ...
    userChoices: [
      { text: "You're all heroes together.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "carry-torch",
    ...
    userChoices: [
      { text: "Keep that flame burning bright.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "honor-every-rescue",
    ...
    userChoices: [
      { text: "Living memorials are the truest kind.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "goodness-remembered",
    ...
    userChoices: [
      { text: "Thank you for choosing goodness.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "voice-sacrifice",
    ...
    userChoices: [
      { text: "Keep that promise.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "courage-not-absence",
    ...
    userChoices: [
      { text: "Courage well-defined.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "earned-rest",
    ...
    userChoices: [
      { text: "Rest well, brave soul.", nextNodeId: "end-sendler" }
    ]
  },
  {
    id: "end-sendler",
...
// Re-export the extended nodes for Elie Wiesel and Gerda Weissmann Klein
export { elieWieselExtendedNodes, gerdaWeissmannExtendedNodes };